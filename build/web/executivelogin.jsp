...
<nav>
   <ul>
        ...
        <li>
            <a href="executivelogin.jsp" class="active">Executive</a>
        </li>
        <li>
...
<div class="form-div animated zoomInUp">
    ...
    <form action="executiveact.jsp" method="post">
        ...
        <p><a href="executivereg.jsp" class="reg">New User Register Here...</a></p>
        <br>
    </form>
</div>
<br>
